...
// 				//CBSS
				...
				if(dimension=="001"){
					cbssChartByProvince(cbss);
				}else{
					cbssChartByMonth(cbss);
				}
			},
	...
	function cbssChartByProvince(result) {
		var myFileChart = echarts.init(document.getElementById('statisCBSS'));
		myFileChart.clear();
		// 显示标题，图例和空的坐标轴
		...
		for (var i = 0; i < result.length; i++) {
			...
			}else if(String(result[i].TCN)=="137"){
	...
	function cbssChartByMonth(result) {
...
<body style="width:100%;height:100%;overflow:auto">
	...
	<div class="u-body">
		...
		<div class="u-search">
			...
			<div class="z-search z-top">
				...
				<div class="search s2" id="monthDiv">
	...
	<div class="data" id="statisCBSS" ></div>
</div>
