...
<div class="u-body">
	...
	<div class="u-search">
		<div class="search">
			<form id="searchForm">
				<label class="name n2" for="">菜单名称：</label>
				<input type="text" class="u-input-text search-box box-input" name="menuName" id="menuName">
			</form>
		</div>
		<div class="button-box-m">
			<a class="button chaxun" onclick="getMenuList('1')">查询</a>
			<c:if test="${sessionScope.funOperate['SYS_MENU_ADD'] }">
			<a href="sysMenu/menuAdd.do"  class="button xinzeng">新增</a>
			</c:if>
		</div>
	</div>
	    <div class="data d2">
