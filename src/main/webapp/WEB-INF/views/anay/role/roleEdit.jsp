		...
		<form>
			<div class="biaodan">
			    <label class="name n1" for="">角色编码：</label>
			     <input id="roleCode" name="roleCode" maxlength="32" type="text" class="b-input-text" readonly disabled value="${role.roleCode }">
			</div>
			<div class="biaodan">
			    <label class="name n1" for="">角&nbsp;&nbsp;色&nbsp;&nbsp;名：</label>
			    <input id="roleName" name="roleName" maxlength="100" type="text" class="b-input-text" value="${role.roleName }" onblur="jiaoyanName();">
			  </div>
			<div class="biaodan">
